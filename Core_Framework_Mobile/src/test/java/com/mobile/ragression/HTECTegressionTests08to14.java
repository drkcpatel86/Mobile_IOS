...
public class HTECTegressionTests08to14 extends BaseTest{
...
//	ExtentTest test ;
	...
	public void OpenApp(Hashtable<String,String> data) throws MalformedURLException{
		// reports
		test = rep.startTest("Opening an App and Selecting Parameter as TC-098 and WO# 16311");
	    ...
	    //going down 
		// scrolldownToString("Crew # TC-041");
...
//	    Idriver.findElement(By.xpath("//*[@accessibilityLabel='txt_work_order']")).click();
	...
	public void HTECRegScenario08() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario08");
		test.log(LogStatus.INFO, "Starting the test Verification of Sub-Division Field exists and it allows user to select sub-division from the spinner, using Parameter as TC-098 and WO# 16311");
	...
	test.log(LogStatus.PASS, "Able to verify Sub-Division Field exists and it allows user to change it using Parameter as TC-098 and WO# 16311");
	
	}
	
	@Test(priority=3)
	public void HTECRegScenario09() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario09");
		test.log(LogStatus.INFO, "Starting the test on the Job Info screen that the “RR Proj. #/Cost Ctr” field exists and allows the user to type in whatever they want using Parameter as TC-098 and WO# 16311");
		...
		test.log(LogStatus.PASS, "Able to verify on the Job Info screen that the “RR Proj. #/Cost Ctr” field exists and allows the user to type in whatever they want using Parameter as TC-098 and WO# 16311");
	}
	
	@Test(priority=4)
	//@Test(priority=4, dependsOnMethods={"ModProRegScenario2"})
	public void HTECRegScenario10() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario10");
		
		test.log(LogStatus.INFO, "Starting the test verify that on the Job Info screen that the “Region” field DOES NOT exist., using Parameter as TC-098 and WO# 16311");
		
		verifyElementAbsent("Region_aid");
		
		test.log(LogStatus.PASS, "Able to the test that on the Job Info screen that the “Region” field DOES NOT exist., using Parameter as TC-098 and WO# 16311");
		}
	@Test(priority=5)
	//@Test(priority=5, dependsOnMethods={"ModProRegScenario3"})
	public void HTECRegScenario11() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario11");
		
		test.log(LogStatus.INFO, "Starting the test verify that on the Job Info screen that the Division Field does not exists, using Parameter as TC-098 and WO# 16311");
		

		verifyElementAbsent("Division_name");
	
	
		test.log(LogStatus.PASS, "Able to the test Verification of Division Field does not exists, using Parameter as ");
	...
	public void HTECRegScenario12() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario12");
	...
	@Test(priority=8)
	//@Test(priority=6, dependsOnMethods={"ModProRegScenario4"})
	public void HTECRegScenario14() throws  InterruptedException{
		test = rep.startTest("HTECRegScenario14");
