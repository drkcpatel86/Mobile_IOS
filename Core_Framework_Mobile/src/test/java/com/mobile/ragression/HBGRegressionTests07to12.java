...
public class HBGRegressionTests07to12 extends BaseTest{
...
//	ExtentTest test ;
	...
	public void OpenApp(Hashtable<String,String> data) throws MalformedURLException{
		// reports
		test = rep.startTest("Opening an App and Selecting Parameter as Unit # BW-880 and WO# 14472");
		...
		test.log(LogStatus.PASS, "Able to open New Report successfully");
			...
			//	wait(6);
				...
				IclickAccs("btn_done_navbar");
					...
					test.log(LogStatus.PASS, "Able to Open an App and Selecting Parameter as BW-880 and WO# 14567");
	}
	

	@Test(priority=2, dependsOnMethods={"OpenApp"})
	public void HBGRegScenario7() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario7");
		test.log(LogStatus.INFO, "Starting the test Verification of Division Field exists and it allows user to change it using Parameter as BW-880 and WO# 14567");
		IclickAccs("Job Info");
		wait(4);
	...
	test.log(LogStatus.PASS, "Able to verify Division Field exists and it allows user to change it using Parameter as BW-880 and WO# 14567");

	}
	
	@Test(priority=3)
	public void HBGRegScenario8() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario8");
		test.log(LogStatus.INFO, "Starting the test Verification of Sub-Division Field exists and it allows user to select sub-division from the spinner, using Parameter as BW-880 and WO# 14567");
	...
	test.log(LogStatus.PASS, "Able to verify Sub-Division Field exists and it allows user to change it using Parameter as BW-880 and WO# 14567");
	}
	
	@Test(priority=4)
	//@Test(priority=4, dependsOnMethods={"ModProRegScenario2"})
	public void HBGRegScenario9() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario9");
		
		test.log(LogStatus.INFO, "Starting the test verify that on the Job Info screen that the “Region” field DOES NOT exist., using Parameter as BW-880 and WO# 14567");
		
		verifyElementAbsent("Region_aid");
		
		test.log(LogStatus.PASS, "Able to the test that on the Job Info screen that the “Region” field DOES NOT exist., using Parameter as BW-880 and WO# 14567");
		}
	@Test(priority=5)
	//@Test(priority=5, dependsOnMethods={"ModProRegScenario3"})
	public void HBGRegScenario10() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario10");
		
		test.log(LogStatus.INFO, "Starting the test verify that on the Job Info screen that the “RR Proj. #/Cost Ctr” Field does not exists, using Parameter as BW-880 and WO# 14567");
		

		verifyElementAbsent("RRProj_Costctr_xpath");
	
	
		test.log(LogStatus.PASS, "Able to the test Verification of “RR Proj. #/Cost Ctr” Field does not exists, using Parameter as BW-880 and WO# 14567");
	...
	public void HBGRegScenario11() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario11");
		test.log(LogStatus.INFO, "Starting the test verify that on the Job Info screen that the RR Word Ord./WLC Field does not exists, using Parameter as BW-880 and WO# 14567");
		
		verifyElementAbsent("RRworkordWLC_aid");
			
		
		test.log(LogStatus.PASS, "Able to the test Verification of RR Word Ord./WLC Field does not exists, using Parameter as BW-880 and WO# 14567");
	}

	@Test(priority=7)
	//@Test(priority=6, dependsOnMethods={"ModProRegScenario4"})
	public void HBGRegScenario12() throws  InterruptedException{
		test = rep.startTest("HBGRegScenario12");
		test.log(LogStatus.INFO, "Starting the test Verification of RR Job No./AFE: Field exists and it allows user to type it using Parameter as BW-880 and WO# 14567");
				
		verifyElementAbsent("RRJob_AFE_name");
	
		test.log(LogStatus.PASS, "Able to the test Verification of RR Job No./AFE: Field exists and it allows user to type it using Parameter as BW-880 and WO# 14567");
	}
